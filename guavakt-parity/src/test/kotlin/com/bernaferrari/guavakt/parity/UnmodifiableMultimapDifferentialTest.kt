...
import com.bernaferrari.guavakt.collect.Multimaps
...
class UnmodifiableMultimapDifferentialTest {
    ...
    private fun trace(source: ArrayListMultimap<String, Int>, view: com.bernaferrari.guavakt.collect.Multimap<String, Int>): List<Any?> {
        val values = view.get("a")
        val keys = view.keySet()
        val allValues = view.values()
        val entries = view.entries()
