...
import com.bernaferrari.guavakt.graph.MutableNetwork
import com.bernaferrari.guavakt.graph.MutableValueGraph
import com.bernaferrari.guavakt.graph.GraphBuilder
import com.bernaferrari.guavakt.graph.NetworkBuilder
import com.bernaferrari.guavakt.graph.ValueGraphBuilder
...
class GraphMutationDifferentialTest {
    ...
    fun sortedNetworkEdgeAliasesAreKotlinSafeWhereGuavaThrowsInternalNpe() {
        ...
        val kotlinNetwork = NetworkBuilder.directed<String, String>()
            .allowsParallelEdges(true)
            .allowsSelfLoops(true)
            .edgeOrder(com.bernaferrari.guavakt.graph.ElementOrder.sorted(byLength))
            .build<String, String>()
    ...
    private fun stableGraphComparatorAliasTrace(directed: Boolean) {
        ...
        val kotlinGraph = (if (directed) GraphBuilder.directed<String>() else GraphBuilder.undirected())
            .allowsSelfLoops(true)
            .nodeOrder(com.bernaferrari.guavakt.graph.ElementOrder.sorted(byLength))
            .incidentEdgeOrder(com.bernaferrari.guavakt.graph.ElementOrder.stable())
            .build<String>()
    ...
    private fun kotlinUndirectedComparatorTrace(comparator: Comparator<String>): List<Any?> {
        val graph = GraphBuilder.undirected<String>()
            .allowsSelfLoops(true)
            .nodeOrder(com.bernaferrari.guavakt.graph.ElementOrder.sorted(comparator))
            .build<String>()
