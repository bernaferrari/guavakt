...
import com.bernaferrari.guavakt.collect.TreeBasedTable as GuavaKtTreeBasedTable
...
class TreeBasedTableDifferentialTest {
    ...
    private fun populate(table: com.bernaferrari.guavakt.collect.Table<Int, Int, String>) {
        table.put(2, 5, "a")
        table.put(1, 9, "b")
        table.put(3, 1, "c")
        table.put(1, 3, "d")
