...
import dev.guavakt.io.ByteStreams
...
class ByteStreamsDataDifferentialTest {
    ...
    fun primitiveAndModifiedUtfWireBytesMatchGuava() {
        ...
        fun writeBoth(action: (com.google.common.io.ByteArrayDataOutput) -> Unit, ours: (dev.guavakt.io.ByteArrayDataOutput) -> Unit) {
            action(guava)
            ours(kotlin)
        }
    ...
    fun indexedInputBufferWindowsAndAllDataOutputWritesMatchGuava() {
        ...
        fun writeBoth(
            ...
            kotlinAction: (dev.guavakt.io.ByteArrayDataOutput) -> Unit,
        ) {
            guavaAction(guava)
            kotlinAction(kotlin)
        }
