...
import dev.guavakt.collect.ArrayListMultimap as GuavaKtArrayListMultimap
import dev.guavakt.collect.Multimaps as GuavaKtMultimaps
...
class MultimapsViewDifferentialTest {
    ...
    fun filteredSetNullableKeyAndMapEqualityMatchGuava() {
        ...
        val guavaKtSource = dev.guavakt.collect.HashMultimap.create<String?, Int>()
    ...
    fun keyFilteredListMultimapIndexedMutationAndFailuresMatchGuava() {
        ...
        val guavaKt: dev.guavakt.collect.ListMultimap<String, Int> =
    ...
    private fun keyFilteredListTrace(
        view: dev.guavakt.collect.ListMultimap<String, Int>,
        source: dev.guavakt.collect.ListMultimap<String, Int>,
    ): List<Any?> {
        val trace = mutableListOf<Any?>()
        view.get("allowed").add(1, 2)
        trace.add(source.get("allowed").toList())
