...
object ByteStreams {
     ...
     */
    fun newDataInput(bytes: ByteArray): com.bernaferrari.guavakt.io.ByteArrayDataInput = ByteArrayDataInput(bytes)
     ...
     */
    fun newDataInput(bytes: ByteArray, start: Int): com.bernaferrari.guavakt.io.ByteArrayDataInput {
    ...
    fun newDataOutput(): com.bernaferrari.guavakt.io.ByteArrayDataOutput = ByteArrayDataOutput()
    fun newDataOutput(size: Int): com.bernaferrari.guavakt.io.ByteArrayDataOutput = ByteArrayDataOutput(size)
    ...
    class ByteArrayDataInput(private val data: ByteArray, start: Int = 0) : com.bernaferrari.guavakt.io.ByteArrayDataInput {
    ...
    class ByteArrayDataOutput(size: Int = 32) : com.bernaferrari.guavakt.io.ByteArrayDataOutput {
