...
val jmhResult = layout.buildDirectory.file("jmh-hash.json")
val jvmTestTask = tasks.named<Test>("jvmTest")

tasks.register<JavaExec>("jmhHash") {
    group = "benchmark"
    description = "Runs reproducible JMH hash workloads; not part of the correctness test suite."
