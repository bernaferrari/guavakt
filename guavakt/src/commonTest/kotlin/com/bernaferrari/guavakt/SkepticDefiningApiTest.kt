...
import com.bernaferrari.guavakt.cache.Cache
import com.bernaferrari.guavakt.cache.CacheBuilderSpec
import com.bernaferrari.guavakt.cache.ForwardingCache
import com.bernaferrari.guavakt.collect.AbstractBiMap
import com.bernaferrari.guavakt.collect.CompactHashMap
import com.bernaferrari.guavakt.collect.ForwardingMap
import com.bernaferrari.guavakt.collect.HashBasedTable
import com.bernaferrari.guavakt.collect.ImmutableBiMap
import com.bernaferrari.guavakt.collect.LinkedHashMultiset
import com.bernaferrari.guavakt.collect.ObjectArrays
import com.bernaferrari.guavakt.collect.Tables
import com.bernaferrari.guavakt.math.BigIntegerMath
import com.bernaferrari.guavakt.math.LinearTransformation
import com.bernaferrari.guavakt.net.HttpHeaders
import com.bernaferrari.guavakt.primitives.UnsignedLong
...
class SkepticDefiningApiTest {
    ...
    fun cacheBuilderSpecAndForwardingCache() {
        ...
        val inner = object : Cache<String, Int> {
            ...
            override fun stats() = com.bernaferrari.guavakt.cache.CacheStats(0, 0, 0, 0, 0, 0)
    ...
    fun forwardingListMultimapGetPutRemoveAll() {
        val inner = com.bernaferrari.guavakt.collect.ArrayListMultimap.create<String, Int>()
        val fwd = object : com.bernaferrari.guavakt.collect.ForwardingListMultimap<String, Int>() {
    ...
    fun transformedAndSequentialIterators() {
        ...
        val transformed = object : com.bernaferrari.guavakt.collect.TransformedIterator<Int, String>(backing) {
            override fun transform(from: Int): String = "n=$from"
        }
        assertEquals(listOf("n=1", "n=2", "n=3"), transformed.asSequence().toList())
        val seq = object : com.bernaferrari.guavakt.collect.AbstractSequentialIterator<Int>(1) {
    ...
    fun networkAddEdgeIncidentNodes() {
        val net = com.bernaferrari.guavakt.graph.NetworkBuilder.directed<String, String>().build<String, String>()
        net.addEdge("a", "b", "e1")
