# GuavaKt contributor and agent guide

This is the starting point for anyone changing GuavaKt: people, coding agents, and future
maintainers. It explains how the repository is organized, which compatibility promises are real,
and how to make a change without turning a Kotlin Multiplatform library into a JVM-only Guava clone.
...
Keep the repository root small: `README.md` for consumers and this file for contributors/agents.
