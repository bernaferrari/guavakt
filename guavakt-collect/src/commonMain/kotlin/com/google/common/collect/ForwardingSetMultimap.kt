...
/** Guava ForwardingSetMultimap — forwards set-multimap calls to [delegate]. */
abstract class ForwardingSetMultimap<K, V> : SetMultimap<K, V> {
    protected abstract fun delegate(): SetMultimap<K, V>
