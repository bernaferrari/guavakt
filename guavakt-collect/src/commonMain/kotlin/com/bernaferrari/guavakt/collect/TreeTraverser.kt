 ...
 * `com.bernaferrari.guavakt.graph.Traverser.forTree`, which supports the same traversal orders. Nodes are
 * non-null by type, child order is preserved, and cycles are not detected because the input is
 * assumed to be a tree.
 */
@Deprecated(
    message = "Use com.bernaferrari.guavakt.graph.Traverser.forTree instead",
